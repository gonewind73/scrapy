...
class domainsprider():
    ...
    def __init__(self,keyword):
        self.list=[]
        self.csvfile=open('baidu.csv', 'w', newline='')
    ...
    def spride(self,url):
        ...
        Dl=re.findall(r'(?<=http://www.baidu.com/link\?url=)[^"]*(?=")',html)
        print(Dl)
        dts= list(set(Dl))  
        for i in range(0,len(dts)):
            dts[i]="http://www.baidu.com/link?url="+dts[i]
...
if __name__ == '__main__':
    ...
    for i in range(0,10):
        url="https://www.baidu.com/s?wd="+keyword+"&pn="+str(i*10)
        print(url)
